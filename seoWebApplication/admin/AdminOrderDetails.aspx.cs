...
namespace seoWebApplication
{
    public partial class AdminOrderDetails : System.Web.UI.Page
    {
        ...
        {
            // obtain order info
            OrderInfo orderInfo = OrdersAccessor.GetInfo(orderId);
            ...
            grid.DataSource = OrdersAccessor.GetDetails(orderId);
            grid.DataBind();
        }
        ...
        protected void editButton_Click(object sender, EventArgs e)
            ...
            {
                // Update the order
                OrdersAccessor.Update(orderInfo);
            }
            catch (Exception ex)
            {
        ...
        protected void markVerifiedButton_Click(object sender, EventArgs e)
        {
            ...
            string orderId = Request.QueryString["OrderID"];
            // mark order as verified
            OrdersAccessor.MarkVerified(orderId);
            // update the form
            PopulateControls(orderId);
        }
        ...
        protected void markCompletedButton_Click(object sender, EventArgs e)
        {
            ...
            OrdersAccessor.MarkCompleted(orderId);
            // update the form
            PopulateControls(orderId);
        }
        ...
        protected void markCanceledButton_Click(object sender, EventArgs e)
        {
            ...
            OrdersAccessor.MarkCanceled(orderId);
            // update the form
            PopulateControls(orderId);
        }
