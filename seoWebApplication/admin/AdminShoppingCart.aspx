<%@ Page Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="AdminShoppingCart.aspx.cs" Inherits="seoWebApplication.AdminShoppingCart" %>
...
<p><asp:Label ID="countLabel" runat="server">Hello!</asp:Label></p>
<p>
