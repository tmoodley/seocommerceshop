...
{
    public partial class ProductCustomAttributes : System.Web.UI.UserControl
    {
        ...
        { 
            ...
            string attributeName, attributeValue, attributeValueId, attValAmt;
                ...
                using (var dc = new seowebappDataContextDataContext())
                {
                    ...
                    if (Convert.ToBoolean(dc.productCustomAttById(id)))
                    {

                        DataTable attrTable = catalogAccesor.GetCustomAttributes(1,id);
                        ...
                        attributeValue = r["attName"].ToString();
                        attributeValueId = r["AttributeValueID"].ToString();
                        attValAmt = r["Value"].ToString();
