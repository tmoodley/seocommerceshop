<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CustomerDetailsEdit.ascx.cs" Inherits="seoWebApplication.UserControls.CustomerDetailsEdit" %>
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ConnectionString="<%$ ConnectionStrings:seowebappConnectionString %>" 
    SelectCommand="customerInsert" SelectCommandType="StoredProcedure">
    <SelectParameters>
        <asp:Parameter Direction="InputOutput" Name="customer_id" Type="Int32" />
        ...
        <asp:Parameter Name="dayPhone" Type="Decimal" />
        <asp:Parameter Name="cellPhone" Type="Decimal" />
        <asp:Parameter Name="evePhone" Type="Decimal" />
